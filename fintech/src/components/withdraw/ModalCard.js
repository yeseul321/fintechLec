...
const ModalCard = ({ bankName, fintechUseNo, tofintechno }) => {
  ...
  const genTransId = () => {
    ...
    let transId = "M202201567U" + countnum; //이용기과번호 본인것 입력
    return transId;
  };
  ...
  const deposit = () => {
    const twoLeggedToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiIxMTAxMDExMjI2Iiwic2NvcGUiOlsiaW5xdWlyeSIsImxvZ2luIiwidHJhbnNmZXIiXSwiaXNzIjoiaHR0cHM6Ly93d3cub3BlbmJhbmtpbmcub3Iua3IiLCJleHAiOjE2Njc5NzA5OTEsImp0aSI6ImQzNmI0NzU1LWNkYTMtNDgzMS1hZGZmLWU2YTE0YTEyMDQ2NyJ9.nXZo2hzP_SYhNqtPCC_LuLzxHMGd_WgQUZmRpXmkBsc";
